...
import static com.example.dell.rxjavademo.App.getAppContext;
...
public class SharePreUtils {
	...
	public static void put(String key, Object value){
		put(getAppContext(), key, value);
	}
	
	public static <T> T get(String key, Object defValue){
		Object value = get(getAppContext(), key, defValue);
		return (T)value;
	}
	
	public static void remove(String key){
		remove(getAppContext(), key);
	}
